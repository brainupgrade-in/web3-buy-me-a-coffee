...
const contractAddress = "0x80c1496e7a659038900d7652edfabc49867acb4d";
...
function SocialIcons() {
  return (
    <div className="flex items-center justify-center gap-8">
      <a href="https://twitter.com/brainupgrade4" target="blank">
        <img src="twitter.svg" alt="twitter"></img>
      </a>
      <a href="https://github.com/brainupgrade-in/web3-buy-me-a-coffee" target="blank">
        <img src="github.svg" alt="github"></img>
      </a>
      <a href="https://www.linkedin.com/company/brains-upgrade" target="blank">
    ...
    <div className="flex items-center justify-center gap-4 py-10 text-grey2">
      <div>
        ...
        <a
          ...
          href="https://twitter.com/brainupgrade4"
          target="_blank"
          rel="noreferrer"
        >
          Rajesh Gheware.
        ...
        <a
          className="font-medium text-primary"
          href="https://github.com/brainupgrade-in/web3-buy-me-a-coffee"
          target="_blank"
          rel="noreferrer"
        >
          GitHub.
